...
/* harmony export */   "initDropzones": () => (/* binding */ initDropzones)
/* harmony export */ });
      ...
      dropzone.on('error', function (file, errorMessage, xhr) {
        if (xhr) {
          ...
          Object.keys(errors).forEach(function (key) {
            var label = $("input[name=\"".concat(key, "\"]"));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dropzones__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dropzones */ "./resources/js/dropzones.js");
/* harmony import */ var _validations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./validations */ "./resources/js/validations.js");
// libraries
...
__webpack_require__(/*! jquery-validation */ "./node_modules/jquery-validation/dist/jquery.validate.js"); // custom packages
...
$(document).ready(function () {
  Inputmask({
    "mask": phoneMask
  }).mask(document.querySelectorAll("[rel=phone]"));
  Inputmask({
    "mask": smsCodeMask
  }).mask(document.querySelectorAll("[rel=sms]"));
  (0,_dropzones__WEBPACK_IMPORTED_MODULE_0__.initDropzones)();
  (0,_validations__WEBPACK_IMPORTED_MODULE_1__.initValidations)(validations);
});
  ...
  data.forEach(function (form, index) {
    ...
    var validator = formId.validate({
      ...
      success: function success() {
        if (validator.numberOfInvalids() === 0) buttonId.removeClass('disabled');
      }
    });
  });
}
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/scss/theme.scss");
/******/ 	
/******/ })()
;